        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              ...
              <li class="active"><a href="do.php?action=export">导出</a></li>
...
//print_r($page);
$count=mysqli_query($conn,'select count(*) from l_books');//获得记录总数
...
//print_r($startCount);
//查询数据
$sql="select * from l_books limit $startCount,$perNumber";//根据前面的计算出开始的记录和记录数
...
<center>
<a href="showbooks.php">第一页</a>
<?php 
include_once ("page.php");
?>
<a href="showbooks.php?page=<?php echo $pre;?>">上一页</a>
<?php
for($i=$start;$i<=$end;$i++){
    ?>
    <a href="showbooks.php?page=<?php echo $i;?>"><?php echo $i;?></a>
<?php
}
?>
<a href="showbooks.php?page=<?php echo $next;?>">下一页</a>
