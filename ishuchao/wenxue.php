        ...
        <nav class="navbar navbar-default">
          <div class="container-fluid">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="wenxue.php">文学目录</a>
            </div>
...
//print_r($page);
$count=mysqli_query($conn,"select count(*) from l_books where 类别='文学'");//获得记录总数
...
//print_r($startCount);
//查询数据
$sql="select * from l_books where 类别='文学' limit $startCount,$perNumber ";//根据前面的计算出开始的记录和记录数
...
<center>
<a href="wenxue.php">第一页</a>
<?php 
include_once ("page.php");
?>
<a href="wenxue.php?page=<?php echo $pre;?>">上一页</a>
<?php
for($i=$start;$i<=$end;$i++){
    ?>
    <a href="wenxue.php?page=<?php echo $i;?>"><?php echo $i;?></a>
<?php
}
?>
<a href="wenxue.php?page=<?php echo $next;?>">下一页</a>
